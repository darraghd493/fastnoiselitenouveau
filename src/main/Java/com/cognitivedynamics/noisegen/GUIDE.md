...
import com.cognitivedynamics.noisegen.derivatives.SimplexDerivatives;
```
...
```java
import com.cognitivedynamics.noisegen.*;
import com.cognitivedynamics.noisegen.spatial.*;
import com.cognitivedynamics.noisegen.transforms.*;
import com.cognitivedynamics.noisegen.derivatives.*;
